...
mult = next((line.split()[1] for i, line in enumerate(open('C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\atoms_positions.data')) if i == 6), None)
...
###############
z.to_csv('C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\sorted_atoms_positions.data', header=None, index=None, sep=' ')

#copy header from "atoms_positions.data" to new file "atoms_header.data"
N=12  
with open('C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\atoms_header.data', "w") as file:     
    with open('C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\atoms_positions.data', 'r') as f:
        for i in range(N):
            line = next(f).strip()
            # print(line)
            file.write(line+ '\n')
...
def merge(atoms_header, sorted_atoms_positions, new_atoms_positions):
    file1 = open('C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\atoms_header.data')
    file2 = open('C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\sorted_atoms_positions.data')
    new_file = open('C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\new_atoms_positions.data', "w")
...
out_path = 'C:\\Users\\biknb\\Downloads\\bkc\\Phonons_0.5\\'+sys+'\\'+syst+'\\LAMMPS\\'+sys+'_'+alat+'_'+temp+'\\'
os.chdir(out_path)
